...
<template>
  ...
  <div v-else>
    ...
    <main class="tw-bg-white tw-p-5">
      <div class="tw-flex tw-border-b tw-py-10 tw-border-b-gray-300">
        <div class="tw-w-[25%] tw-px-4 tw-hidden md:tw-block">
          <h1 class="tw-mt-4 tw-text-gray-600 tw-font-bold tw-text-lg">Personnal Information</h1>
          <p class="tw-text-slate-600 tw-text-xs tw-text-justify">
        ...
        <div class="md:tw-w-[75%] tw-w-full">
          <div class="md:tw-flex tw-justify-between">
            <img
              class="tw-h-40 tw-rounded-full tw-ml-auto md:tw-ml-0 tw-my-4"
              :src="authStore.user.profile_photo_url"
              alt=""
            />
            <div class="tw-mt-6 md:tw-my-auto tw-text-right tw-mr-6">
              <button
                @click="logout"
          ...
          <div>
            <div class="tw-flex">
              <div class="tw-mt-4 tw-pr-4 tw-w-full">
                <label class="tw-w-full tw-text-gray-600 tw-text-lg tw-mx-2 tw-font-bold" for=""
                  >Username</label
                >
                <input
                  v-model="authStore.user.name"
                  class="tw-mx-2 tw-px-2 tw-text-black tw-w-full tw-rounded-md tw-text-s tw-py-2 tw-my-2 focus:tw-outline-blue-800 tw-bg-[#dee2e6]"
                  type="text"
                  required
                />
              </div>
      ...
      <div class="tw-flex tw-border-b tw-py-10 tw-border-b-gray-300">
        <div class="tw-w-[25%] tw-px-4 tw-hidden md:tw-block">
          <h1 class="tw-mt-4 tw-text-gray-600 tw-font-bold tw-text-lg">Password update</h1>
          <p class="tw-text-slate-600 tw-text-xs tw-text-justify">
      ...
      <div class="tw-flex tw-justify-between tw-py-10">
        <div class="tw-w-[25%] tw-px-4 tw-hidden md:tw-block">
          <h1 class="tw-mt-4 tw-text-gray-600 tw-font-bold tw-text-lg">Password update</h1>
          <p class="tw-text-slate-600 tw-text-xs tw-text-justify">
            Delete your account. This action is irreversible and will delete all your data.
          </p>
        </div>
        <button
          @click="deleteAccount"
